...
import { FarmerCreation } from '../pages/masters/farmer-creation/FarmerCreation';
import { VlccMembers } from '../pages/masters/vlcc/VlccMembers';
import { Vehicle } from '../pages/masters/vehicle/Vehicle';
import { Plants } from '../pages/masters/plants/Plants';
import { ChillingCenter } from '../pages/masters/chilling-centers/ChillingCenter';
import { Path } from '../pages/masters/routes/Path';
import { Companies } from '../pages/masters/companies/Companies';
import { CollectionCenters } from '../pages/masters/collection-centers/CollectionCenters';
import { CenterSettings } from '../pages/masters/collection-centers/CenterSettings';
import { RateChart } from '../pages/masters/rate-chart/RateChart';
import { UserCreation } from '../pages/masters/user-creation/UserCreation';
    ...
    <ScrollToTop>
      <Routes>
        ...
        <Route path='masters'>
          ...
          <Route path='vlcc' element={<VlccMembers />} />
          <Route path='vehicle' element={<Vehicle />} />
          <Route path='plants' element={<Plants />} />
          <Route path='cc' element={<ChillingCenter />} />
          <Route path='routes' element={<Path />} />
          <Route path='companies' element={<Companies />} />
          <Route path='collection-centers' element={<CollectionCenters />} />
          <Route path='center-setting' element={<CenterSettings />} />
