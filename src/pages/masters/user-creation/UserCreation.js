...
import { Block, Icon, Media, MediaAction, MediaGroup, MediaText, Select } from '../../../components';
import { Alert, Button, Card, Col, Form, Image, ListGroup, Nav, OverlayTrigger, Row, Tab, Tooltip } from 'react-bootstrap';
import { Link } from 'react-router-dom';
export const UserCreation = () => {
  return (
    <Layout title="User Creation" content="container">
    <Block.Head>
