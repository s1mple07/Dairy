...
export const Snf = () => {
    ...
    const handleSubmit = () => {
        ...
        if (isValid) {
            ...
            const newStart = parseFloat(start) || 0
            const newEnd = parseFloat(end) || 0 // If you want to format end as well, use .toFixed(2) as necessary
    ...
    return (
        <Card className="card-gutter-md">
            <Card.Body>
                <Row className="g-gs">
                    <Block.Title tag="h2" className="mb-2">FAT Only</Block.Title>
                    <Col lg="3">
