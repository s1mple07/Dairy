...
import { tableData, tableColumns, vlccData, vlccColumn, plantsColumn, plantsData, plantcolumn } from '../../../components/DataTable/TableData';
...
export const Plants = () => {
    ...
    const filteredData = plantsData.filter(row =>
    ...
    return (
        <Layout title="Data Tables" content="container">
            <Block.Head page className="wide-md">
                <Block.HeadContent>
                    <Block.Title>Plants</Block.Title>
                </Block.HeadContent>
            </Block.Head>
            ...
            <Block>
                <Card>
                <DataTable tableClassName="data-table-head-light table-responsive" data={plantsData} columns={plantcolumn(handleCellClick, showFilters, handleFilterChange)} expandableRows actions showFilters={showFilters} toggleFilters={toggleFilters}  />
                </Card>
            </Block>
